...
class SuperConvergence(Callback):
    ...
    def __init__(self, epochs, div_factor=25., final_div_factor=1e4, pct_start=0.3,
                 snapshot=True, directory="checkpoint", model_name=None):
        """
        :param epochs: number of epoch to run
    ...
    def extra_repr(self):
        return f"epochs={self.epochs}, div_factor={self.div_factor}, final_div_factor={self.final_div_factor}, pct_start={self.pct_start}, " \
